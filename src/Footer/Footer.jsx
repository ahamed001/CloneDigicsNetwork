  ...
  return (
    <div className='bg-white md:h-32 h-80'>
      <div className='bg-blue-900 md:h-28 h-72 md:flex md:justify-around'>
        <p className='text-white py-5 md:py-0 my-auto md:px-0 px-16 text-center'>Copyright &copy; {currentYear} bitss.fr | All Rights Reserved</p>
        ...
        <div className=' my-5 md:my-auto'>
          <p className='text-white md:px-0 px-10 text-center'>Cookie Policy Contact Us</p>
        </div>
