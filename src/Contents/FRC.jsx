...
const FRC = () => {
  return (
    <div>
        ...
        <div className='flex text-left w-[80%] mx-auto'>

            <div className='w-[400px] p-4'>
                <div className=' bg-white m-2 px-12'>
                    ...
                    <p className='pb-12 pt-4 font-bold text-sm hover:cursor-pointer hover:text-red-500'>READ MORE &rarr;</p>
                </div>
                <div className=' bg-white m-2 px-12'>
